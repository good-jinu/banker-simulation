export const en = {
  ...
  market: {
    ...
    districtMarket: "RIVERSIDE DISTRICT",
    districtPressure: "NORTH YARD DISTRICT",
    ...
    select: "Select",
    close: "Close",
    goalFirstLoan: "First loan",
    goalCumulativeLoans: "Lend $500",
    goalNetWorth: "Net worth $1,500",
    challengeGoalLoans: "Issue 3 loans",
    challengeGoalProduct: "Create a loan product",
    challengeGoalCumulativeLoans: "Lend at least $1,500",
    challengeGoalNetWorth: "Reach $1,400 in net worth",
    goalSurvive: "Survive day 26",
    ...
    createLoanProduct: "Activate loan product",
